...
graph TD
    ...
    Atendente --> UC3[RF-003: Visualizar Pet]
    Atendente --> UC4[RF-004: Agendar Consultas]

    UC3 --> |Include| UC5[RF-005: Visualizar Histórico de Consultas]

```

### 4.2 Diagramas de Classes

Demonstra as entidades, seus atributos, métodos e relacionamentos.

Relacionamento entre Pet e Consultas de **1 para muitos (1:N)**
